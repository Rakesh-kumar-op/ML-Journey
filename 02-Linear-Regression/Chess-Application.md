...
In the Andrew Ng course, we used Linear Regression to predict house prices based on size [cite: 2026-03-27]. In my chess project, I repurposed this:
...
* **Learning Rate ($\alpha$):** I had to tune this carefully to ensure the model converged on thousands of games pulled from the Chess.com API [cite: 2026-04-02].
